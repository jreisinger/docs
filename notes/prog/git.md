...
```bash
$ git add .     # add files in working directory to a temporary storage - staging index
```
...
```bash
$ git commit    # add files in staging index to a permanent storage - repository (.git directory)
```
